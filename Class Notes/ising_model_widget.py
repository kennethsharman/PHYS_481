...
#bLabel = Tkinter.Label(controlFrame, text="Magnetic Field: ")
#bLabel.pack(side="left")
#bSlider = Tkinter.Scale(controlFrame, from_=0.01, to=10.0, resolution=0.01, length=120, orient="horizontal")
